...
# ✅ FIX: Direct import without try-except untuk production
...
class LearningStrategyGenerator:
    ...
    def __init__(self, api_key: str, resources_path: str = "data.json"):
        ...
        try:
            ...
            print(f"⚠️ Failed to load resources: {e}")
            self.resources = []
...
if __name__ == "__main__":
    ...
    # ⚠️ GANTI API KEY INI DENGAN MILIK ANDA!
    ...
    try:
        ...
        print("⚠️ Warning: data.json tidak ditemukan, melanjutkan tanpa references")
        strategy_gen = LearningStrategyGenerator(
            api_key=GEMINI_API_KEY,
            resources_path="data.json"
        )
